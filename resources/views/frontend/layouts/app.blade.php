...
<body>
    ...
    <div class="mobile-menu">
        <div class="container">
            <div class="mobile-menu-wrapper">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('/frontend/assets/images/logo/logo.png')}}" alt="Mukti">
                    </a>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center px-15">
                    <div class="header-logo">
                        <a href="index.html" class="logo"><img src="{{asset('frontend/assets/images/logo/logo.png')}}" alt="logo"></a>
                    </div>
    ...
    <section id="about" class="feature-section padding-tb bg-color">
        <div class="container">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="five">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="http://labartisan.net/demo/mukti/assets/images/depart/4.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="six">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="http://labartisan.net/demo/mukti/assets/images/depart/5.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="seven">
                                        <div class="row flex-row-reverse align-items-center">
                                            <div class="col-12 col-lg-6">
                                                <div class="post-thumb">
                                                    <img src="http://labartisan.net/demo/mukti/assets/images/depart/6.jpg" alt="depart">
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="post-content">
        ...
        <div class="container">
            <div class="section-wrapper">
                ...
                <div class="counter-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="counter-item-inner">
                        <div class="counter-thumb">
                            <img src="http://labartisan.net/demo/mukti/assets/images/counter/03.png" alt="counter">
                        </div>
                        <div class="counter-content">
    ...
    <section id="services" class="service-section style-1 padding-tb bg-color">
        <div class="container">
            ...
            <div class="section-wrapper">
                ...
                <div class="service-item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="http://labartisan.net/demo/mukti/assets/images/service/02.jpg" alt="service">
                        </div>
                        <div class="service-content">
                ...
                <div class="service-item wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="http://labartisan.net/demo/mukti/assets/images/service/03.jpg" alt="service">
                        </div>
                        <div class="service-content">
                ...
                <div class="service-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                    <div class="service-inner">
                        <div class="service-thumb">
                            <img src="http://labartisan.net/demo/mukti/assets/images/service/04.jpg" alt="service">
                        </div>
                        <div class="service-content">
    ...
    <section id="contact" class="newsletter-section style-1">
        <div class="container">
            <div class="section-wrapper">
